...
/**
 * WifiConfigurationAp - titik akses untuk konfigurasi Wi-Fi.
 *
 * Kelas ini membuat hotspot Wi-Fi dengan portal tangkapan untuk mengatur
 * kredensial Wi-Fi. Driver Wi-Fi harus sudah diinisialisasi sebelum kelas ini
 * digunakan.
 */
...
public:
    ...
    // Nonaktifkan copy constructor dan assignment operator.
    ...
    /**
     * Atur fungsi panggil balik saat ada permintaan keluar dari mode konfigurasi.
     *
     * Fungsi panggil balik ini dipanggil ketika pengguna meminta keluar dari mode
     * konfigurasi, misalnya melalui rute `/exit`.
     */
