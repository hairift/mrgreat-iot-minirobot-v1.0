...
void WifiManager::NotifyEvent(WifiEvent event, const std::string& data) {
    // Salin fungsi panggil balik saat mutex terkunci, lalu panggil di luar kunci agar tidak deadlock
...
void WifiManager::StartStation() {
    ...
    // Hentikan otomatis AP konfigurasi jika sedang aktif
...
void WifiManager::StartConfigAp() {
    ...
    // Hentikan otomatis mode stasiun jika sedang aktif
    if (station_active_) {
