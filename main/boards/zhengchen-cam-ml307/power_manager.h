...
private:
    ...
    void ReadBatteryAdcData() {
        ...
        // Periksa apakah sudah melewati ambang baterai lemah
        if (adc_values_.size() >= kBatteryAdcDataCount) {
    ...
    void ReadTemperature() {
        ...
        if (abs(temperature - current_temperature_) >= 3.5f) {  // Callback hanya dipicu jika perubahan suhu melebihi 3,5°C
