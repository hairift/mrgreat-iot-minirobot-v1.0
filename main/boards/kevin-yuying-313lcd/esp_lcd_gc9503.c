                                   ...
                                   esp_lcd_panel_handle_t *ret_panel)
{
    ...
    if (gc9503->flags.auto_del_panel_io)
    {
        ...
        /**
         * Agar pin antarmuka SPI 3-kawat (seperti SDA dan SCK) bisa berbagi dengan pin lain pada antarmuka RGB
         * (seperti HSYNC) untuk menghemat GPIO, perintah inisialisasi LCD perlu dikirim melalui antarmuka SPI 3-kawat
        ...
        // Setelah perintah inisialisasi dikirim, antarmuka SPI 3-kawat dapat dihapus
...
static esp_err_t panel_gc9503_send_init_cmds(gc9503_panel_t *gc9503)
{
    ...
    // sebaiknya rujuk ke pemasok LCD untuk kode urutan inisialisasinya
...
static esp_err_t panel_gc9503_disp_on_off(esp_lcd_panel_t *panel, bool on_off)
{
    ...
    {
        ESP_RETURN_ON_FALSE(io, ESP_FAIL, TAG, "Panel IO is deleted, cannot send command");
        // Kendalikan layar nyala atau mati melalui perintah LCD
        if (on_off)
        {
    ...
    {
        // Kendalikan layar nyala atau mati melalui sinyal kendali layar
