...
private:
    ...
    void CheckBatteryStatus() {
        ...
        // Jika data level baterai belum cukup, baca ulang data baterai
    ...
    void ReadBatteryAdcData() {
        ...
        // Tambahkan nilai ADC ke antrean sampel
...
public:
    PowerManager(gpio_num_t pin) : charging_pin_(pin) {
        // Inisialisasi pin deteksi pengisian
    ...
    bool IsDischarging() {
        // Karena tidak dibedakan khusus, mode pelepasan daya memakai status kebalikan
        return !is_charging_;
    }
