...
#include <algorithm>  // Digunakan untuk std::max/std::min
                ...
                switch (current_event.type) {
                    case TouchEventType::SINGLE_CLICK:
                        if (current_event.x == 40) {
                            ...
                            app.ToggleChatState();  
                        } else if (current_event.x == 20) {     // Klik tunggal pada 20,600: volume naik
                        ...
                        } else if (current_event.x == 60) {     // Klik tunggal pada 60,600: volume turun
                            int current_vol = codec->output_volume();
                            int new_vol = current_vol - 10;
