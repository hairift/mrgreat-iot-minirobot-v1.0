...
private:
    ...
    static esp_err_t bsp_enable_dsi_phy_power(void) {
        ...
        // Nyalakan daya PHY MIPI DSI agar status berubah dari "tanpa daya" ke "siaga mati".
    ...
    void InitializeButtons() {
        boot_button_.OnClick([this]() {
            ...
            // Saat perangkat baru menyala dan belum terhubung, menekan tombol BOOT akan
            // masuk ke mode konfigurasi Wi-Fi tanpa menyalakan ulang perangkat.
    ...
    void InitializeSdCard() {
        ...
        // Petakan pin melalui matriks GPIO jika diperlukan
