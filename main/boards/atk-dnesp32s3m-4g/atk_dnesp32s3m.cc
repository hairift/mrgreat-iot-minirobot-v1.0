...
private:
    ...
    void InitializeButtons() {
        ...
        // Kondisi tanpa earphone terpasang
        phone_button_.OnPressDown([this]() {
            gpio_set_level(SPK_EN_PIN, 1);
        });

        // Kondisi earphone terpasang
    ...
    void InitializeSt7735Display() {
        ...
        // Inisialisasi pengendali layar ST7735
        ...
        // Periksa apakah earphone terpasang, level tinggi menandakan earphone terpasang
        io_conf.intr_type = GPIO_INTR_DISABLE;
