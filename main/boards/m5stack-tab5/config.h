...
#define AUDIO_CODEC_PA_PIN       GPIO_NUM_NC // Dikendalikan oleh PI4IOE
...
#define TOUCH_INT_GPIO  GPIO_NUM_23  // Interupsi sentuh

const ili9881c_lcd_init_cmd_t tab5_lcd_ili9881c_specific_init_code_default[] = {
    // {cmd, { data }, ukuran_data, jeda}
    /**** Halaman perintah 1 ****/
    {0xFF, (uint8_t[]){0x98, 0x81, 0x01}, 3, 0},
    {0xB7, (uint8_t[]){0x03}, 1, 0},  // atur 2 lajur
    /**** Halaman perintah 3 ****/
...
// Perintah inisialisasi khusus vendor untuk ST7123
