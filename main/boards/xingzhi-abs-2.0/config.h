...
#define Power_Control GPIO_NUM_47               // Pin kendali daya
#define Power_Dec GPIO_NUM_48                   // Pin deteksi tombol daya
#define POWER_CBS_ADC_UNIT ADC_UNIT_1           // Unit ADC bersama di GPIO1
#define POWER_USBIN_ADC_CHANNEL ADC_CHANNEL_0   // Deteksi apakah USB terpasang di GPIO1
#define POWER_BATTERY_ADC_CHANNEL ADC_CHANNEL_6 // Deteksi level baterai di GPIO7
