...
public:
    ...
    void SetupUI() override {
        ...
        // Terapkan gaya warna khusus setelah objek LVGL dari induk selesai dibuat
...
private:
    ...
    void InitializeNv3023Display(){
        ...
        // Inisialisasi chip pengendali LCD NV3023
...
public:
    magiclick_c3() : boot_button_(BOOT_BUTTON_GPIO) {
        ...
        // Gunakan pin VDD SPI ESP32-C3 sebagai GPIO biasa
