...
#define MAX_SEND_PACKETS_IN_QUEUE (3600 / OPUS_FRAME_DURATION_MS)
#define AUDIO_TESTING_MAX_DURATION_MS 10000
#define MAX_TIMESTAMPS_IN_QUEUE 3

#define AUDIO_POWER_TIMEOUT_MS 45000
...
public:
    ...
    bool IsIdle();
    bool WaitForPlaybackQueueEmpty(int timeout_ms = -1);
...
private:
    ...
    void WaitForTaskStop(TaskHandle_t& task_handle, const char* task_name);
};
